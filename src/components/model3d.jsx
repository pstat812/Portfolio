...
// 3D Model import
import spaceman3dModel from '/models/tenhun_falling_spaceman_fanart.glb?url'

export function Model3d(props) {
  const group = useRef()
  const { nodes, materials, animations } = useGLTF(spaceman3dModel)
  ...
  const ySpring = useSpring(yPosition, {damping: 45, mass: 20, stiffness: 75})
  useEffect(() => { 
...
Model3d.prototype = Object.create(Group.prototype)
Model3d.prototype.constructor = Model3d

useGLTF.preload(spaceman3dModel)
